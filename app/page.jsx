  ...
  return (
    <div>
      <div className="flex h-screen">
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-4 pb-8 bg-[#292a2d] text-white relative">
          ...
          {messages.length === 0 ? (
            ...
            <div className="flex items-center gap-3">
              ...
              <p className="text-2xl font-medium">Hi, I'm DeepSeek Ayush's version.</p>
            </div>
        ...
        <p className="text-xs absolute bottom-1 text-gray-500">I can make mistakes, but Ayush can't!!</p>
